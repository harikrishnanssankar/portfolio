...
const Index = () => {
  return (
    <motion.div variants={routeAnimation} initial="initial" animate="animate" className="flex flex-col px-6 pt-1 justify-center align-center flex-grow ">
      ...
      <div className="p-4 mt-5 bg-gray-400 dark:bg-dark-100 flex-grow " style={{marginLeft: "-1.5rem", marginRight: "-1.5rem"}} >
        ...
        <motion.div variants={stagger} initial="initial"animate="animate" className="grid lg:grid-cols-2 gap-6">
          {services.map((service) => {
            return (
              <motion.div variants={fadeInUp}  className="flex items-center lg:col-span-1 rounded-lg bg-gray-200 dark:bg-dark-200" >
