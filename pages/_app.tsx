  ...
  return (
    <ThemeProvider attribute="class">
      <div className="grid grid-cols-12 gap-6 my-8 lg:px-20 px-5">
        ...
        <div className="lg:col-span-9 bg-white dark:bg-dark-500  rounded-2xl col-span-12 flex flex-col overflow-hidden dark:bg-dark-500 shadow-custom-light dark:shadow-custom-dark">
          <Navbar />
          <Component {...pageProps} />
        </div>
      </div>
