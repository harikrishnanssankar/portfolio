...
const handleFilterCategory = (category:Category | "all") => {
  ...
  return (
    <motion.div  variants={routeAnimation} initial="initial" animate="animate" exit="exit" className="px-5 py-2"  >
      ...
      <motion.div variants={stagger} initial="initial" animate="animate" className="grid grid-cols-12 gap-4 my-3  projectList__container overflow-y-auto" style={{height:"410px"}}>
